...
Фрагмент с примерами на ./010_html/060_anchor
#### Информационные страницы (4-6), которые должны содержать:
6.	Навигацию (раздел 1, раздел 2, к началу ) внутри страницы с использование закладок (см. ./010_html/060_anchor);
...
10.	Таблицу, содержащую: изображение на заднем фоне всей таблицы, изображение в одной из ячеек, изображение, гиперссылки. См. ./010_html/040_tables
...
Фрагмент с примерами на https: ./010_html/050_forms    
...
<br><br>__03.Создать страницу для решения алгоритмической задачи. Название страницы "Решение алгоритмической задачи".  Пример представлен на https://vmarshirov.github.io/BasicsOfWebTechnologies/030_js/public_html/0121_abc.html
...
<br>- по своему номеру с использованием ./task_01/01_students&numbers.pdf определить номер задачи
<br>-  по номеру задачи в ./task_01/02_numbres&tasks.txt определиться с содержанием задачи
...
<br>Пример на https://vmarshirov.github.io/BasicsOfWebTechnologies/030_js/public_html/0121_abc.html
