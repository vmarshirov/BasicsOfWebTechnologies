...
5.	Страницу с частично повторяющимся контентом (блоками), 6-12 повторений. Фрагмент страницы на https://vmarshirov.github.io/BasicsOfWebTechnologies/020_css/090_bootstrap/shop.html. Рекомендуется использовать JS
