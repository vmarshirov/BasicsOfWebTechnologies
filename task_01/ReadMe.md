...
<br>- по своему номеру с использованием ./01_students&numbers.pdf определить номер задачи
<br>-  по номеру задачи в ./02_numbres&tasks.txt определиться с содержанием задачи
