...
Фрагмент с примерами на https://github.com/vmarshirov/BasicsOfWebTechnologies/tree/main/010_html/060_anchor
#### Информационные страницы (4-6), которые должны содержать:
6.	Навигацию (раздел 1, раздел 2, к началу ) внутри страницы с использование закладок (см. https://github.com/vmarshirov/BasicsOfWebTechnologies/tree/main/010_html/060_anchor);
...
10.	Таблицу, содержащую: изображение на заднем фоне всей таблицы, изображение в одной из ячеек, изображение, гиперссылки. См. https://github.com/vmarshirov/BasicsOfWebTechnologies/tree/main/010_html/040_tables
...
Фрагмент с примерами на https: https://github.com/vmarshirov/BasicsOfWebTechnologies/tree/main/010_html/050_forms    
...
<br>- по своему номеру с использованием https://github.com/vmarshirov/BasicsOfWebTechnologies/blob/main/task_01/01_students%26numbers.pdf определить номер задачи
<br>-  по номеру задачи в https://github.com/vmarshirov/BasicsOfWebTechnologies/blob/main/task_01/02_numbres%26tasks.txt определиться с содержанием задачи
